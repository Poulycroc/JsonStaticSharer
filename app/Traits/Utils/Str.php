...
class Str
{
    ...
    {
        $b = ['[br]', '[h1]', '[/h1]', '[b]', '[/b]', '[strong]', '[/strong]', '[i]', '[/i]', '[em]', '[/em]', '&apos;', '&lt;', '&gt;', '&quot;'];
        $h = ['<br />', '<h1>', '</h1>', '<strong>', '</strong>', '<strong>', '</strong>', '<em>', '</em>', '<em>', '</em>', '\'', '<', '>', '"'];
    ...
    public static function sanitizeFilename($str)
    {
        ...
        $str = preg_replace(['/[\&]/', '/[\@]/', '/[\#]/'], ['-and-', '-at-', '-number-'], $str);
     ...
     * @return mixed
     */
    public static function strtr($haystack, $aMatch, $aDelimiter = ['{', '}'])
    {
        return call_user_func_array([self, 'smrtr'], func_get_args());
    }
     ...
     * @return string
     */
    public static function smrtr($haystack, $aMatch, $aDelimiter = ['{', '}'])
    {
        $aCleaned = [];
    ...
    {
        $str = str_replace([' ', 'é', 'è', 'ó', 'à', 'â', ',', '?', "'"], ['+', '%E9', '%E8', 'o', '%E0', '%E2', '%82', '%3F', '%27'], $str);
